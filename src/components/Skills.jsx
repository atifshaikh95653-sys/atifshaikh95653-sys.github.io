...
function SkillItem({ skill }) {
  ...
  const color = getSkillColor(skill.name, skill.icon);
              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  {category.items.map((item) => {
                    ...
                    const skillIcon = typeof item === 'string' ? undefined : item.icon;
                    const Icon = getSkillIcon(skillName, skillIcon);
                    const color = getSkillColor(skillName, skillIcon);
                    return (
                      <span
                        key={skillName}
